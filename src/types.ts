...
export type AuthContextType = {
    ...
    login: () => void,
    logout: () => void,
    getAccessToken: (auth_code? : string) => Promise<string | undefined>, 
    refreshAccessToken?: (first_visit: boolean) => Promise<string | undefined>,
    apiService?: APIService 
}

export type AuthContextProviderProps = {
    checkAuthOnFirstVisit: boolean, 
    login: () => Promise<void>,
    logout: () => Promise<void>,
    getAccessToken: (auth_code? : string) => Promise<string | undefined>, 
    refreshAccessToken?: (first_visit: boolean) => Promise<string | undefined> 
...
export type RefreshAcessTokenResponseType = {
    access_token: string;
    token_type: string;
    scope: string;
    expires_in: number;
